...
Router1(config-if)#ipv6 address 2001:BD4:ABCD:1112::1/64
Router1(config-if)#ipv6 address FE80::1 link-local
...
Router1(config-if)#ipv6 address 15:0:0:4::2/126
Router2(config-if)#no shutdown
%LINK-5-CHANGED: Interface GigabitEthernet1/0, changed state to up
...
Router1(config-if)#ipv6 address 2001:BD4:ABCD:1113::1/64
Router1(config-if)#ipv6 address FE80::1 link-local
...
Router1(config-if)#ipv6 address 15:0:0:4::1/126
Router3(config-if)#no shutdown
%LINK-5-CHANGED: Interface GigabitEthernet1/0, changed state to up
